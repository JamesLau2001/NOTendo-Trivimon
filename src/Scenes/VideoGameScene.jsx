import { getAllVideoGameQuestions } from "../data/videoGamesQuestions";

const VideoGameScene = (
  setCurrentScene,
  ...
  return {
    preload: function () {
      this.load.image("background", "../../public/triviaScenes/anotherVG.png");
    ...
    create: function () {
      ...
      getAllVideoGameQuestions().then((questions) => {
        allVideoGameQuestions.push(...questions);
        displayQuestion();
      });
